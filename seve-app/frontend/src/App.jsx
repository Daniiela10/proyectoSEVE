...
import GestionColores from "@/pages/GestionColores";
    ...
    <div>
      ...
      <main className={`main-wrap${mostrarSidebarStaff ? " has-staff-sidebar" : ""}`}>
        ...
        <div className="main-content-shell">
          ...
          {vistaPrincipal === "gestion-colores" && esAdmin && <GestionColores />}
        ...
        <div className="footer-body">
          ...
          <div className="footer-col footer-col--brand">
            ...
            <div className="footer-redes">
              ...
              <a href="https://www.tiktok.com/@seve_aluminios?_r=1&_t=ZS-978KJOPLTzp" target="_blank" rel="noopener noreferrer" className="footer-red" aria-label="TikTok">
          ...
          <div className="footer-col">
            ...
            <ul className="footer-nav">
              <li>
                <a href="https://wa.me/573006429254" target="_blank" rel="noopener noreferrer">
